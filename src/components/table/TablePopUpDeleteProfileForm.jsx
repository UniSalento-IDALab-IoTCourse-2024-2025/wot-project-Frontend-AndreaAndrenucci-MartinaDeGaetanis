...
const TablePopUpDeleteProfileForm = ({popupRef, onClose, onConfirm}) => {
        ...
        >
            <div className="relative w-full text-darkglass afacad text-lg max-w-xl bg-white rounded-3xl shadow-lg p-6">
                <div className="text-center mb-4">
                    ...
                    <h3 className="text-xl font-semibold mb-2 text-left">Sei sicuro di voler eliminare il tuo profilo?</h3>
                    <p className="text-lg text-gray-600 text-left">Stai per eliminare il tuo account e tutti i dati associati</p>
                </div>
                <button
                    type="button"
...
export default TablePopUpDeleteProfileForm